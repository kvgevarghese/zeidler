...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { country: @memo.country, memo: @memo.memo, slug: @memo.slug } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { country: @memo.country, memo: @memo.memo, slug: @memo.slug } }
